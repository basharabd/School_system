                                                    ...
                                                    <table class="table center-aligned-table mb-0">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>{{ $list_Sections->classes->class_name }}
                                                                </td>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="#" class="btn btn-outline-info btn-sm"
                                                                        ...
                                                                        trans('Sections_trans.Edit') }}</a>
                                                                    <a href="#" class="btn btn-outline-danger btn-sm"
                                                                        data-toggle="modal"
                                                                        data-target="#delete{{ $list_Sections->id }}">{{
                                                                        trans('Sections_trans.Delete') }}</a>
                                                                </td>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">{{
                                    trans('Sections_trans.Close') }}</button>
                                <button type="submit" class="btn btn-danger">{{ trans('Sections_trans.submit')
                                    }}</button>
                            </div>
                            </form>
                        </div>
